...
class GumletImageResizeManagerTest extends TestCase
{
	...
	public function test_gumlet_manager_save()
	{
		$manager = new GumletImageResizeManager();
	...
	public function test_gumlet_manager_resize()
	{
		$manager = new GumletImageResizeManager();
		$manager->makeImage($this->fixtureImagePath);
	...
	public function test_gumlet_manager_convert()
	{
		$manager = new GumletImageResizeManager();
		$manager->makeImage($this->fixtureImagePath);
	...
	public function test_gumlet_manager_convert_exception()
	{
	...
	public function test_gumlet_manager_resize_exception()
	{
		$this->expectException(ImageManagerException::class);
		$manager = new GumletImageResizeManager();
		$manager->makeImage($this->fixtureImagePath);
	...
	{
		$this->fixtureImagePath = $_SERVER['DOCUMENT_ROOT'] . '/tests/Fixtures/gumlet/test.jpg';
		$this->fixtureImageNewDir = $_SERVER['DOCUMENT_ROOT'] . '/tests/Fixtures/gumlet/save/';
